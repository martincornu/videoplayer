...
static PyCodeObject *codeobj_95837d02fe9870723d962cf9335d76b8;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[52]); CHECK_OBJECT(module_filename_obj);
    codeobj_95837d02fe9870723d962cf9335d76b8 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[53], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_95837d02fe9870723d962cf9335d76b8;
    ...
    // Frame without reuse.
    frame_95837d02fe9870723d962cf9335d76b8 = MAKE_MODULE_FRAME(codeobj_95837d02fe9870723d962cf9335d76b8, module_scipy$stats$_boost);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_95837d02fe9870723d962cf9335d76b8);
    assert(Py_REFCNT(frame_95837d02fe9870723d962cf9335d76b8) == 2);
    ...
    // Framed code:
    {
        ...
        frame_95837d02fe9870723d962cf9335d76b8->m_frame.f_lineno = 1;
        {
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_95837d02fe9870723d962cf9335d76b8->m_frame.f_lineno = 7;
    ...
    tmp_import_from_2__module = NULL;
    {
        ...
        frame_95837d02fe9870723d962cf9335d76b8->m_frame.f_lineno = 13;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_95837d02fe9870723d962cf9335d76b8);
#endif
    popFrameStack();

    assertFrameObject(frame_95837d02fe9870723d962cf9335d76b8);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_95837d02fe9870723d962cf9335d76b8, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_95837d02fe9870723d962cf9335d76b8->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_95837d02fe9870723d962cf9335d76b8, exception_lineno);
    }

...
static PyCodeObject *codeobj_dff6ea8899b1ca62ab73519aff1d2e82;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[122]); CHECK_OBJECT(module_filename_obj);
    codeobj_dff6ea8899b1ca62ab73519aff1d2e82 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[123], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_dff6ea8899b1ca62ab73519aff1d2e82;
    ...
    // Frame without reuse.
    frame_dff6ea8899b1ca62ab73519aff1d2e82 = MAKE_MODULE_FRAME(codeobj_dff6ea8899b1ca62ab73519aff1d2e82, module_scipy$stats$_distr_params);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_dff6ea8899b1ca62ab73519aff1d2e82);
    assert(Py_REFCNT(frame_dff6ea8899b1ca62ab73519aff1d2e82) == 2);
    ...
    }
    {
        ...
        frame_dff6ea8899b1ca62ab73519aff1d2e82->m_frame.f_lineno = 4;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_dff6ea8899b1ca62ab73519aff1d2e82);
#endif
    popFrameStack();

    assertFrameObject(frame_dff6ea8899b1ca62ab73519aff1d2e82);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_dff6ea8899b1ca62ab73519aff1d2e82, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_dff6ea8899b1ca62ab73519aff1d2e82->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_dff6ea8899b1ca62ab73519aff1d2e82, exception_lineno);
    }
